...
export class FakePosts1597424501177 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`insert into post (title, text, "creatorId", "createdAt") values ('Robin Hood', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.
